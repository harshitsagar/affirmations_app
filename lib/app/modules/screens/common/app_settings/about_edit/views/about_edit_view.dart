...
class AboutEditView extends GetView<AboutEditController> {
  ...
  Widget _buildTextField(TextEditingController controller, String hintText) {
    final isEmailField = hintText == "Email"; // Check if this is the email field

    return SizedBox(
      height: 40.h,
      child: TextFormField(
        controller: controller,
        enabled: !isEmailField, // Disable only for email field
        style: GoogleFonts.inter(
          fontSize: 16.sp,
          fontWeight: FontWeight.w500,
          color: isEmailField
              ? Colors.black.withOpacity(0.6) // Slightly faded for email
              : Colors.black, // Normal color for other fields
        ),
        decoration: InputDecoration(
          ...
          filled: true,
          fillColor: isEmailField
              ? Colors.white.withOpacity(0.7) // Slightly more transparent for email
              : Colors.white.withOpacity(0.9), // Normal opacity for other fields
        ),
      ),
    );
  }
