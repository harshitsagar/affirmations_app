class FreezeStreakModel {
  ...
  final FreezeStreakModelData? data;
  final String? format;
  final DateTime? timestamp;

  factory FreezeStreakModel.fromJson(Map<String, dynamic> json){
    return FreezeStreakModel(
      code: json["code"],
      message: json["message"],
      data: json["data"] == null ? null : FreezeStreakModelData.fromJson(json["data"]),
      format: json["format"],
...
class FreezeStreakModelData {
  FreezeStreakModelData({
  ...
  factory FreezeStreakModelData.fromJson(Map<String, dynamic> json){
    return FreezeStreakModelData(
